...
public final class Constants {
    ...
    // The whole day WITH the long read, for authenticated PRO users. Deliberately its
    // own region: DAILY_CONTENT_BY_DATE is keyed on date alone, so sharing it would let
    // one subscriber's response be replayed to every free user asking for the same day.
    public static final String FULL_DAILY_CONTENT_BY_DATE = "fullDailyContentByDate";
